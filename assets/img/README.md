...
| `markup@2x.webp` / `markup@1x.jpg` | `scene-markup.svg` | Home "Mark it up with Apple Pencil" | Apple Pencil ink over a real Mac window — circle something, an arrow, a written word — with the "Screen paused for markup" bar and its Copy Screenshot button up. |
